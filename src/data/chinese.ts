  ...
  lessons: [
    {
      ...
      emoji: '👀',
      kind: 'appendix',
      hint: '本册要求认识的字（共 274 个，按课本识字表顺序，含语文园地多音字复习）。点字可听发音。',
      hanzi: [
        ...
        { char: '掠', pinyin: '', group: [], mean: '' },
        { char: '吟', pinyin: '', group: [], mean: '' },
        { char: '辽', pinyin: 'liáo', group: ['辽阔'], mean: '远；广阔。' },
        { char: '阔', pinyin: 'kuò', group: ['宽阔'], mean: '宽广。' },
        { char: '眯', pinyin: '', group: [], mean: '' },
        ...
        { char: '陌', pinyin: '', group: [], mean: '' },
        { char: '吗', pinyin: '', group: [], mean: '' },
        { char: '讨', pinyin: '', group: [], mean: '' },
        { char: '厌', pinyin: '', group: [], mean: '' },
        { char: '访', pinyin: '', group: [], mean: '' },
        { char: '记', pinyin: '', group: [], mean: '' },
        { char: '忍', pinyin: '', group: [], mean: '' },
        { char: '委', pinyin: '', group: [], mean: '' },
        { char: '屈', pinyin: '', group: [], mean: '' },
        { char: '中', pinyin: '', group: [], mean: '' },
        { char: '弹', pinyin: '', group: [], mean: '' },
        { char: '疯', pinyin: '', group: [], mean: '' },
        { char: '局', pinyin: '', group: [], mean: '' },
        { char: '汪', pinyin: 'wāng', group: ['汪汪'], mean: '狗叫声。' },
        { char: '搞', pinyin: 'gǎo', group: ['搞定'], mean: '做；弄。' },
        { char: '恒', pinyin: '', group: [], mean: '' },
        { char: '圣', pinyin: '', group: [], mean: '' },
        { char: '萌', pinyin: '', group: [], mean: '' },
        { char: '妥', pinyin: '', group: [], mean: '' },
        { char: '轴', pinyin: '', group: [], mean: '' },
        { char: '阁', pinyin: '', group: [], mean: '' },
        { char: '培', pinyin: '', group: [], mean: '' },
        { char: '厘', pinyin: '', group: [], mean: '' },
        { char: '普', pinyin: '', group: [], mean: '' },
        { char: '少', pinyin: '', group: [], mean: '' },
        { char: '矩', pinyin: '', group: [], mean: '' },
        { char: '丫', pinyin: '', group: [], mean: '' },
        { char: '宫', pinyin: '', group: [], mean: '' },
        { char: '掘', pinyin: '', group: [], mean: '' },
        { char: '希', pinyin: '', group: [], mean: '' },
        { char: '冲', pinyin: '', group: [], mean: '' },
        { char: '联', pinyin: '', group: [], mean: '' },
        { char: '系', pinyin: '', group: [], mean: '' },
        { char: '葵', pinyin: '', group: [], mean: '' },
        { char: '瘦', pinyin: '', group: [], mean: '' },
        { char: '罢', pinyin: '', group: [], mean: '' },
        { char: '答', pinyin: '', group: [], mean: '' },
        { char: '应', pinyin: '', group: [], mean: '' },
        { char: '及', pinyin: '', group: [], mean: '' },
        { char: '卷', pinyin: '', group: [], mean: '' },
        { char: '骨', pinyin: '', group: [], mean: '' },
        { char: '碌', pinyin: '', group: [], mean: '' },
        { char: '齿', pinyin: '', group: [], mean: '' },
        { char: '嚼', pinyin: '', group: [], mean: '' },
        { char: '吞', pinyin: '', group: [], mean: '' },
        { char: '胃', pinyin: '', group: [], mean: '' },
        { char: '咽', pinyin: '', group: [], mean: '' },
        { char: '宣', pinyin: '', group: [], mean: '' },
        { char: '处', pinyin: '', group: [], mean: '' },
        ...
        { char: '禁', pinyin: '', group: [], mean: '' },
        { char: '旧', pinyin: '', group: [], mean: '' },
        { char: '聚', pinyin: '', group: [], mean: '' },
        { char: '申', pinyin: '', group: [], mean: '' },
        { char: '介', pinyin: '', group: [], mean: '' },
        { char: '绍', pinyin: '', group: [], mean: '' },
        { char: '宗', pinyin: '', group: [], mean: '' },
        { char: '旨', pinyin: '', group: [], mean: '' },
        { char: '占', pinyin: '', group: [], mean: '' },
        { char: '乏', pinyin: '', group: [], mean: '' },
        { char: '舱', pinyin: '', group: [], mean: '' },
        { char: '啦', pinyin: '', group: [], mean: '' },
        ...
        { char: '崖', pinyin: '', group: [], mean: '' },
        { char: '参', pinyin: '', group: [], mean: '' },
        { char: '懒', pinyin: '', group: [], mean: '' },
        ...
        { char: '胳', pinyin: '', group: [], mean: '' },
        { char: '滩', pinyin: '', group: [], mean: '' },
        { char: '睬', pinyin: '', group: [], mean: '' },
        ...
        { char: '螺', pinyin: '', group: [], mean: '' },
        { char: '螃', pinyin: '', group: [], mean: '' },
        { char: '蟹', pinyin: '', group: [], mean: '' },
        { char: '鲤', pinyin: '', group: [], mean: '' },
        { char: '鲫', pinyin: '', group: [], mean: '' },
        { char: '鲨', pinyin: '', group: [], mean: '' },
        { char: '司', pinyin: '', group: [], mean: '' },
        { char: '皆', pinyin: '', group: [], mean: '' },
        { char: '弃', pinyin: '', group: [], mean: '' },
        { char: '裕', pinyin: '', group: [], mean: '' },
        ...
        { char: '锅', pinyin: 'guō', group: ['铁锅', '火锅'], mean: '烹煮食物的器具。' },
        { char: '侦', pinyin: 'zhēn', group: ['侦察', '侦探'], mean: '暗中察看；调查。' },
        { char: '睁', pinyin: '', group: [], mean: '' },
        { char: '眨', pinyin: '', group: [], mean: '' },
        { char: '瞪', pinyin: '', group: [], mean: '' },
        { char: '瞅', pinyin: '', group: [], mean: '' },
        { char: '怒', pinyin: '', group: [], mean: '' },
        { char: '眶', pinyin: '', group: [], mean: '' },
        { char: '呆', pinyin: '', group: [], mean: '' },
        { char: '睹', pinyin: '', group: [], mean: '' },
      ],
      quiz: [],
    },
    {
      ...
      emoji: '✍️',
      kind: 'appendix',
      hint: '本册要求会写的字（共 251 个）。点字可听发音，每天练几个更扎实。',
      hanzi: [
    ...
    },
    {
      ...
      emoji: '📝',
      kind: 'appendix',
      hint: '本册要求掌握的词语（共 246 个）。可用于听写和造句练习。',
      words: [
    '学校',
    '山坡',
    '飘扬',
